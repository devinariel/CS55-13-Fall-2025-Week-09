    ...
    <section className="img__section mb-8">
      ...
      <div className="details__container">
        <div className="details">
          <h2 className="text-2xl md:text-3xl mb-4">{clinician.name}</h2>

          <div className="clinician__rating mb-4">
          ...
          {clinician.modality && <p className="text-sm md:text-base mb-4" style={{ color: '#F1EAD8' }}>Modality: {clinician.modality}</p>}
          <div className="mt-6">
            {children}
          </div>
        </div>
